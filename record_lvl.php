<?php  
$name_page = 'record_lvl';
include 'header.php';


echo '<h1>'.$lang['TopLvl'] . '</h1>';
?>
<title><?php echo $lang['TopLvl']; ?></title>
<div class="form">

    <form action="record_lvl.php" method="get" name="form">
    <?php 
...
//    (print_r($sum_num));
    ...
    if (isset($_GET['nick']) and $_GET['nick'] != ''){
        ...
        if ($sum_num !=0){
            echo "<div class=\"sum_place center\"> Призыватель " . $info[$summoner_id][0] . ': ' .  $sum_num+1 . ' <a href="record_lvl.php' . '?'.$urlParams . $page_summoner . '#' .$sum_num+1  . '">&#8658;</a></div>';
        }
