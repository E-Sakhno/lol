...
?>
<title><?php echo $lang['Top-h']; ?></title>
<div class="form">
...
//    (print_r($sum_num));
    ...
    if (isset($_GET['nick']) and $_GET['nick'] != ''){
        ...
        if ($sum_num !=0){
            $sum_plus = $sum_num+1;
            echo "<div class=\"sum_place center\"> Призыватель " . $info[$summoner_id][0] . ': ' .  $sum_plus . ' <a href="record_total.php' . '?'.$urlParams . $page_summoner . '#' . $sum_plus  . '">&#8658;</a></div>';
        }
