<?php  
$name_page = 'record_total_mastery';

include 'header.php';


echo '<h1>'.$lang['TopMastery-h'] . '</h1>';
?>
<title><?php echo $lang['TopMastery-h']; ?></title>
<div class="form">
...
//    (print_r($sum_num));
    ...
    if (isset($_GET['nick']) and $_GET['nick'] != ''){
        ...
        if ($sum_num !=0){
            echo "<div class=\"sum_place center\"> Призыватель " . $info[$summoner_id][0] . ': ' .  $sum_num+1 . ' <a href="record_total_mastery.php' . '?'.$urlParams . $page_summoner . '#' .$sum_num+1  . '">&#8658;</a></div>';
        }
