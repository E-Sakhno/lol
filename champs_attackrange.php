<?php
include "header.php";
echo '<h1>' . $lang['Attackrange'] . '</h1>';
?>
<title><?php echo $lang['Attackrange']; ?></title>
<div class="blok"> 
    ...
    <th data-type="number"><?php echo $lang['Attackrange'];?></th>          
...
'<td class="center">' . $value['stats']['attackrange'] . '</td>' . 
'</tr>';
