...
'<td class="center">' . $value['stats']['mpregen']/5 . '</td>' . 
'<td class="center">' . $value['stats']['mpregenperlevel']/5 . '</td>' . 
'<td class="center">' . $value['stats']['mpregen']/5 +  17 * $value['stats']['mpregenperlevel']/5 . '</td>' . 
'</tr>';
