<?php  
$name_page = 'record_true_mainers';
include 'header.php';


echo '<h1>'.$lang['TopTrueMainer-h'] . '</h1>';
?>
<title><?php echo $lang['TopTrueMainer-h']; ?></title>
<div class="form">
...
//    (print_r($sum_num));
    ...
    if (isset($_GET['nick']) and $_GET['nick'] != ''){
        ...
        if ($sum_num !=0){
            echo "<div class=\"sum_place center\"> Призыватель " . $info[$summoner_id][0] . ': ' .  $sum_num+1 . ' <a href="record_true_mainers.php' . '?'.$urlParams . $page_summoner . '#' .$sum_num+1  . '">&#8658;</a></div>';
        }
...
<th data-type="number">' . $lang['AmountHeros'] . '</th>
<th>' . $lang['Rang'] . '</th></tr>
</thead>
    <tbody>'
;
